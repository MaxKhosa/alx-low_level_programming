 ...
 *
 * Return: A pointer to the new to buffer.
 */
char *create_buffer(char *file)
{
	char *buffer;
...
/**
 * main - Writes a copy of the contents of a file to another file.
 ...
 * If file_from does not exist and cannot be read - exit code 98.
